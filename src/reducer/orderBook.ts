import { CHANGE_CONTRACT_TYPE, CHANGE_VIEW_STATE } from '../constants/actionTypes';
...
const orderBookReducer = (state: OrderBookReducer = initialState, action: OrderBookActions): OrderBookReducer =>  {
  switch(action.type) {
